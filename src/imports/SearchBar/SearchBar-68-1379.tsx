import svgPaths from "./svg-l74q81j9jm";

function TextInput() {
  return (
    <div className="absolute bg-white content-stretch flex h-[56px] items-center left-0 overflow-clip pl-[48px] pr-[16px] py-[16px] rounded-[46px] shadow-[0px_4px_12px_0px_rgba(0,0,0,0.08)] top-0 w-[720px]" data-name="Text Input">
